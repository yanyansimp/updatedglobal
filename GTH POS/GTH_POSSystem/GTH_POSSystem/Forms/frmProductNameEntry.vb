...
Public Class frmProducNameEntry
...
#End Region
    ...
    Private Sub LoadSupplierListing()
        ...
        sqladapter = New SqlClient.SqlDataAdapter("SELECT     UnitCode AS ID, UnitName FROM         UnitType WHERE UNITName like '%" & txtSearch.Text & "%' order by UnitName", conn)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If btnSave.Text = "&Update" Then
            ...
            Call UPDATE_DATA_TO_DATABASE_USING_ANY_FIELD_AS_PARAMETER("UNITType", strVALUES, "UNITCODE=" & txtSuppID.Text & "")
        Else
