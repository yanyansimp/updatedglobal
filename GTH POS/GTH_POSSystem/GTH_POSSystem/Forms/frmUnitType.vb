...
#End Region
    ...
    Private Sub LoadSupplierListing()
        ...
        sqladapter = New SqlClient.SqlDataAdapter("SELECT     UnitCode AS ID, UnitName FROM         tblUnitType WHERE UNITName like '%" & txtSearch.Text & "%' order by UnitName", conn)
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        If btnNew.Text = "&New" Then
            ...
            txtSuppID.Text = getFieldMaxCount("tblUnitType", "UnitCode") + 1
            txtSuppName.Focus()
        Else
            Call change_bkGround(Color.White)
            btnClose.Text = "&Cancel"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If btnSave.Text = "&Update" Then
            Dim strVALUES As String = "UNITNAME ='" & Replace(txtSuppName.Text, " '", "''") & "'"
            Call UPDATE_DATA_TO_DATABASE_USING_ANY_FIELD_AS_PARAMETER("tblUNITType", strVALUES, "UNITCODE=" & txtSuppID.Text & "")
        Else
            Dim strVALUES As String = "'" & Replace(txtSuppName.Text, "'", "''") & "'"
            Call INSERT_DATA_TO_DATABASE("tblUNITTYPE", "UNITNAME", strVALUES)
        End If
